...
contract RTCPOS { using SafeMath for uint ; IERC20Token public tokenContract ; address public owner;
...
uint32 public interestEpoch = 6678400 ; //3% per 31 days or 1 month

uint8 interest = 300 ; //1% interest
